...
set output "graf0.eps"
set output "graf0.png"
...
set format x "%6.0f"
set format y "%.6f"
plot "data0.dat" using 1:2 title "1e7" with linespoints ls 1, \
"data_perfecto.dat" using 1:2 title "perfecto" with linespoints ls 2